...
namespace tui {
    enum keys {
        ...
        KEY_SPACE = 32, KEY_EXCLAMATION_MARK, KEY_DOUBLE_QUOTES, KEY_NUMBER_SIGN, KEY_DOLLAR_SIGN, KEY_PERCENT, KEY_AMPERSAND, KEY_SINGLE_QUOTE,
        ...
        KEY_COLON = 58, KEY_SEMICOLON, KEY_LESS_THAN, KEY_EQUALS, KEY_GREATER_THAN, KEY_QUESTION_MARK, KEY_AT,
        KEY_UPPERCASE_A = 65, KEY_UPPERCASE_B, KEY_UPPERCASE_C, KEY_UPPERCASE_D, KEY_UPPERCASE_E, KEY_UPPERCASE_F, KEY_UPPERCASE_G, KEY_UPPERCASE_H,
        ...
        KEY_LEFT_BRACKET = 91, KEY_BACKSLASH, KEY_RIGHT_BRACKET, KEY_CARET, KEY_UNDERSCORE, KEY_GRAVE_ACCENT,
        KEY_LOWERCASE_A = 97, KEY_LOWERCASE_B, KEY_LOWERCASE_C, KEY_LOWERCASE_D, KEY_LOWERCASE_E, KEY_LOWERCASE_F, KEY_LOWERCASE_G, KEY_LOWERCASE_H,
